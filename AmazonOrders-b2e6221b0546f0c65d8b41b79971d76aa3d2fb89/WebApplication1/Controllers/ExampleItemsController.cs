...
using WebApplication1.Models.CodeFirst;
...
namespace WebApplication1.Controllers
{
    public class ExampleItemsController : Controller
    {
        ...
        public ExampleItemsController(WebApplication1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ExampleItem != null ? 
                          ...
                          Problem("Entity set 'WebApplication1Context.ExampleItem'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebApplication1Context.ExampleItem'  is null.");
            }
            var exampleItem = await _context.ExampleItem.FindAsync(id);
            if (exampleItem != null)
            {
